...
public class Menu {
  ...
  // Constructor de Colegio que crea los parámetros.

  public Menu(Colegio colegio){
    this.colegio = colegio;
  }

  //Método para generar las opciones del programa.

  public void opciones() throws IOException{

    // Utilizamos el lector para ingresar a la opcion a eleccion
  ...
  public void agregarEvaluacion(BufferedReader lector) throws IOException{
    ...
    try{
      ...
      for(int i = 0 ;i < cantNotas ; i++){
        ...
        System.out.println ("Ingrese el estudiante de nota n°"+(i+1));
  ...
  public void agregarPregunta(BufferedReader lector, Evaluacion ee) throws IOException{
    ...
    if(buscPreg != null){
      System.out.println("La pregunta ya está registrada");
      return;
    }
  ...
  // Método que muestra todas las evaluaciones de una asignatura.
  ...
  public void verPreguntasEva(BufferedReader lector)throws IOException{
    //Se muestran todas las preguntas de una evaluacion
  ...
  public void importar() throws IOException {
    ...
    linea=csv.nextLine();
    int i = 0; //indica cada elemento recorrido
    while(linea!=null){  
      i = 0;
      Evaluacion ee = new Evaluacion(); 
  ...
  public void reporte()throws IOException{
    ...
    escritor.close();
    System.out.println("El reporte se realizó con éxito");
  }
